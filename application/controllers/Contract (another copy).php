...
class Contract extends CI_Controller
{
     ...
     */
     public function getPrioritiesList()
     {
        ...
        $priorit_rslt = $this->Contract_model->getPrioritiesList($data);
    ...
    public function getContractExport()
    {
        ...
        $headers = ['Contract Code','Contract Name','Contract Type','Supplier','MGO','DCQ','Price Units','State','Geo Area','Start Date','End Date','Excess Limit','OverDraw Price','UnderDraw Price','Transport Price'];
